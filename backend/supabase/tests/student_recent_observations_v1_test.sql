...
select set_config('request.jwt.claim.role', 'authenticated', true);
select set_config('request.jwt.claims', '{"sub":"a0000000-0000-0000-0000-000000000009","role":"authenticated","iss":"supabase-demo"}', true);
set local role authenticated;
...
select set_config('request.jwt.claim.role', 'authenticated', true);
select set_config('request.jwt.claims', '{"role":"authenticated","iss":"supabase-demo"}', true);
set local role authenticated;
