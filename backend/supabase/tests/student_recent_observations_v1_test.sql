...
select set_config('request.jwt.claim.role', 'authenticated', true);
select set_config('request.jwt.claims', '{"sub":"a0000000-0000-0000-0000-000000000009","role":"authenticated","iss":"https://reference-provider.invalid/auth/v1"}', true);
set local role authenticated;
...
select set_config('request.jwt.claim.role', 'authenticated', true);
select set_config('request.jwt.claims', '{"role":"authenticated","iss":"https://reference-provider.invalid/auth/v1"}', true);
set local role authenticated;
